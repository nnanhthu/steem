...
# local imports
from beowulfdebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a beowulfd debug node on an existing chain, trigger a hardfork' \
...
def run_beowulfd_tests( debug_node ):
   from beowulfapi.beowulfnoderpc import BeowulfNodeRPC
   ...
   try:
      ...
      rpc = BeowulfNodeRPC( 'ws://127.0.0.1:8095', '', '' )
      ...
      print( "account, curation_beowulf" )
