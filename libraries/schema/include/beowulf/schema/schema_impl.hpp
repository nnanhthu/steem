...
#define BEOWULF_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
BEOWULF_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define BEOWULF_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define BEOWULF_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define BEOWULF_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
BEOWULF_DECLARE_SCHEMA_CLASS( false, false )
BEOWULF_DECLARE_SCHEMA_CLASS(  true, false )
BEOWULF_DECLARE_SCHEMA_CLASS(  true,  true )
