...
{
   FC_ASSERT( _db.has_hardfork( BEOWULF_SMT_HARDFORK ), "SMT functionality not enabled until hardfork ${hf}", ("hf", BEOWULF_SMT_HARDFORK) );
   ...
   else
   {
      ...
      if( dgpo.smt_creation_fee.symbol == BEOWULF_SYMBOL )
         creation_fee = _db.to_beowulf( o.smt_creation_fee );
      else
   ...
   //_db.adjust_balance( BEOWULF_NULL_ACCOUNT,  o.smt_creation_fee );
...
//   FC_ASSERT( smt.beowulf_units_min_cap < 0 || smt.beowulf_units_hard_cap < 0, "Both min cap and max hard cap have already been revealed" );
//
//   if( smt.beowulf_units_min_cap < 0 )
//      try
//      {
//         o.cap.validate( smt.capped_generation_policy.min_beowulf_units_commitment );
//         _db.modify( smt, [&]( smt_token_object& smt_object )
//         {
//            smt_object.beowulf_units_min_cap = o.cap.amount;
//         });
//         return;
//      }
//      catch( const fc::exception& e )
//      {
//         if( smt.beowulf_units_hard_cap >= 0 )
//            throw;
//      }
//
//   o.cap.validate( smt.capped_generation_policy.hard_cap_beowulf_units_commitment );
//   _db.modify( smt, [&]( smt_token_object& smt_object )
//   {
//      smt_object.beowulf_units_hard_cap = o.cap.amount;
//   });
//}
//
