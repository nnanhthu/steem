...
FC_REFLECT( beowulf::chain::hardfork_property_object,
   (id)(processed_hardforks)(last_hardfork)(current_hardfork_version)
   (next_hardfork)(next_hardfork_time) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::hardfork_property_object, beowulf::chain::hardfork_property_index )
