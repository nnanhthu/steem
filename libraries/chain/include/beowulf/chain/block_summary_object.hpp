...
FC_REFLECT( beowulf::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::block_summary_object, beowulf::chain::block_summary_index )
