...
#include <beowulf/chain/util/rd_dynamics.hpp>
...
namespace beowulf { namespace chain {
   ...
   using beowulf::protocol::digest_type;
   using beowulf::protocol::public_key_type;
   using beowulf::protocol::version;
   using beowulf::protocol::hardfork_version;
   using beowulf::protocol::price;
   using beowulf::protocol::asset;
   using beowulf::protocol::asset_symbol_type;
   using beowulf::chain::util::rd_dynamics_params;
   ...
   {
      /**
       *  This fee, paid in BEOWULF, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      asset             account_creation_fee =
         asset( BEOWULF_MIN_ACCOUNT_CREATION_FEE, SBD_SYMBOL );
...
//      uint16_t          sbd_interest_rate  = BEOWULF_DEFAULT_SBD_INTEREST_RATE;
       ...
       * Scaled so that BEOWULF_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
//      int32_t           account_subsidy_budget = BEOWULF_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
       ...
       * Scaled so that 1 << BEOWULF_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
...
//         uint64_t          pow_worker = 0;
         ...
         /**
          * This field represents the Beowulf blockchain version the witness is running.
          */
...
//         int64_t           available_witness_account_subsidies = 0;
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, BEOWULF_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( beowulf::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( beowulf::chain::chain_properties,
...
FC_REFLECT( beowulf::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::witness_object, beowulf::chain::witness_index )

FC_REFLECT( beowulf::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::witness_vote_object, beowulf::chain::witness_vote_index )

FC_REFLECT( beowulf::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::witness_schedule_object, beowulf::chain::witness_schedule_index )
