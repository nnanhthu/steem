...
namespace beowulf { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert sbd to beowulf
    */
...
//   };
    ...
    *  1000 BEOWULF or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return beowulf_volume * sbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(beowulf_volume,sbd_volume) * is_positive();
         }
         ...
         {
            return ( beowulf_volume > 0 && sbd_volume > 0 ) ? 1 : 0;
         }
   };
...
//FC_REFLECT( beowulf::chain::limit_order_object,
//             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::limit_order_object, beowulf::chain::limit_order_index )

FC_REFLECT( beowulf::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::feed_history_object, beowulf::chain::feed_history_index )

FC_REFLECT( beowulf::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::convert_request_object, beowulf::chain::convert_request_index )

FC_REFLECT( beowulf::chain::liquidity_reward_balance_object,
             (id)(owner)(beowulf_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::liquidity_reward_balance_object, beowulf::chain::liquidity_reward_balance_index )

FC_REFLECT( beowulf::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::withdraw_vesting_route_object, beowulf::chain::withdraw_vesting_route_index )

//FC_REFLECT( beowulf::chain::savings_withdraw_object,
//             (id)(from)(to)(memo)(request_id)(amount)(complete) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::savings_withdraw_object, beowulf::chain::savings_withdraw_index )

//FC_REFLECT( beowulf::chain::escrow_object,
//             (id)(escrow_id)(from)(to)(agent)
//             (ratification_deadline)(escrow_expiration)
//             (sbd_balance)(beowulf_balance)(pending_fee)
//             (to_approved)(agent_approved)(disputed) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::escrow_object, beowulf::chain::escrow_index )

//FC_REFLECT( beowulf::chain::decline_voting_rights_request_object,
//             (id)(account)(effective_date) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::decline_voting_rights_request_object, beowulf::chain::decline_voting_rights_request_index )

//FC_REFLECT( beowulf::chain::reward_fund_object,
//            (id)
//            (name)
//            (reward_balance)
//            (recent_claims)
...
//         )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::reward_fund_object, beowulf::chain::reward_fund_index )
