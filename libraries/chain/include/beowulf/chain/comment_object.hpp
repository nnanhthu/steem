...
//#ifdef BEOWULF_ENABLE_SMT
//FC_REFLECT( beowulf::chain::comment_object,
//             (id)(author)(permlink)
...
//          )
//#endif
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::comment_object, beowulf::chain::comment_index )

//FC_REFLECT( beowulf::chain::comment_content_object,
//            (id)(comment)(title)(body)(json_metadata) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::comment_content_object, beowulf::chain::comment_content_index )
//
//FC_REFLECT( beowulf::chain::comment_vote_object,
//             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
//          )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::comment_vote_object, beowulf::chain::comment_vote_index )

//namespace helpers
//{
//   using beowulf::chain::shared_string;
//
//   template <>
//   class index_statistic_provider<beowulf::chain::comment_index>
//   {
//   public:
//      typedef beowulf::chain::comment_index IndexType;
////      typedef typename beowulf::chain::comment_object::t_beneficiaries t_beneficiaries;
////#ifdef BEOWULF_ENABLE_SMT
////      typedef typename beowulf::chain::comment_object::t_votable_assets t_votable_assets;
////#endif
...
//
//   template <>
//   class index_statistic_provider<beowulf::chain::comment_content_index>
//   {
//   public:
//      typedef beowulf::chain::comment_content_index IndexType;
//
//      index_statistic_info gather_statistics(const IndexType& index, bool onlyStaticInfo) const
//      {
//         index_statistic_info info;
