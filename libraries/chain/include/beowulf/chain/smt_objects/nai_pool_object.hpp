...
FC_REFLECT( beowulf::chain::nai_pool_object, (id)(num_available_nais)(nais) )

CHAINBASE_SET_INDEX_TYPE( beowulf::chain::nai_pool_object, beowulf::chain::nai_pool_index )
