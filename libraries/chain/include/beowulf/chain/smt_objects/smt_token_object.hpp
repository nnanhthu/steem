...
//   uint32_t             cashout_window_seconds = BEOWULF_CASHOUT_WINDOW_SECONDS;
//   uint32_t             reverse_auction_window_seconds = BEOWULF_REVERSE_AUCTION_WINDOW_SECONDS_HF20;

//   uint32_t             vote_regeneration_period_seconds = BEOWULF_VOTING_MANA_REGENERATION_SECONDS;
//   uint32_t             votes_per_regeneration_period = SMT_DEFAULT_VOTES_PER_REGEN_PERIOD;

//   uint128_t            content_constant = BEOWULF_CONTENT_CONSTANT_HF0;
...
//   time_point_sec                launch_expiration_time;
   ...
   // smt_cap_reveal
//   share_type  beowulf_units_min_cap = -1;
//   share_type  beowulf_units_hard_cap = -1;
};
...
//   time_point_sec                        schedule_time = BEOWULF_GENESIS_TIME;
//   beowulf::protocol::smt_emissions_unit   emissions_unit;
//   uint32_t                              interval_seconds = 0;
//   uint32_t                              interval_count = 0;
//   time_point_sec                        lep_time = BEOWULF_GENESIS_TIME;
//   time_point_sec                        rep_time = BEOWULF_GENESIS_TIME;
...
} } // namespace beowulf::chain

FC_REFLECT_ENUM( beowulf::chain::smt_phase,
                  (account_elevated)
                  (setup_completed)
//                  (contribution_begin_time_completed)
//                  (contribution_end_time_completed)
...
//FC_REFLECT( beowulf::chain::smt_token_object::smt_market_maker_state,
//   (beowulf_balance)
//   (token_balance)
//   (reserve_ratio)
//)

FC_REFLECT( beowulf::chain::smt_token_object,
   (id)
   (liquid_symbol)
   (control_account)
   (phase)
...
//   (beowulf_units_min_cap)
//   (beowulf_units_hard_cap)
)

//FC_REFLECT( beowulf::chain::smt_token_emissions_object,
//   (id)
//   (symbol)
//   (schedule_time)
//   (emissions_unit)
...
//)
//
//FC_REFLECT( beowulf::chain::smt_event_token_object,
//   (id)
//   (parent)
//   (phase)
//   (generation_begin_time)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::smt_token_object, beowulf::chain::smt_token_index )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::smt_token_emissions_object, beowulf::chain::smt_token_emissions_index )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::smt_event_token_object, beowulf::chain::smt_event_token_index )
