...
public:   
   ...
   asset               liquid;   /// 'balance' for BEOWULF
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_beowulf_balance' for pending BEOWULF
   asset               pending_vesting_shares;  /// 'reward_vesting_balance' for pending VESTS
   asset               pending_vesting_value;   /// 'reward_vesting_beowulf' for pending VESTS
...
FC_REFLECT( beowulf::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (vesting)
...
FC_REFLECT( beowulf::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::account_regular_balance_object, beowulf::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::account_rewards_balance_object, beowulf::chain::account_rewards_balance_index )
