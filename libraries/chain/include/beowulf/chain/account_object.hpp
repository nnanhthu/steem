...
#include <beowulf/chain/shared_authority.hpp>
...
namespace beowulf { namespace chain {
   ...
   using beowulf::protocol::authority;
...
//         account_name_type reset_account = BEOWULF_NULL_ACCOUNT;
...
//         bool              can_vote = true;
         ...
         asset             balance = asset( 0, BEOWULF_SYMBOL );  ///< total liquid shares held by this account
//         asset             savings_balance = asset( 0, BEOWULF_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  BEOWULF_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
...
//         uint8_t           savings_withdraw_requests = 0;
         ...
         asset             reward_beowulf_balance = asset( 0, BEOWULF_SYMBOL );
         asset             reward_vesting_balance = asset( 0, VESTS_SYMBOL );
         asset             reward_vesting_beowulf = asset( 0, BEOWULF_SYMBOL );
...
//         asset             received_vesting_shares = asset( 0, VESTS_SYMBOL );
         ...
         fc::array<share_type, BEOWULF_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( BEOWULF_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( beowulf::chain::account_object,
             (id)(name)(json_metadata)
             (created)(mined)
...
//             (savings_sbd_balance)(savings_sbd_seconds)(savings_sbd_seconds_last_update)(savings_sbd_last_interest_payment)(savings_withdraw_requests)
             (reward_beowulf_balance)(reward_sbd_balance)(reward_vesting_balance)(reward_vesting_beowulf)
             (vesting_shares)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::account_object, beowulf::chain::account_index )

FC_REFLECT( beowulf::chain::account_authority_object,
             (id)(account)(owner)(active)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::account_authority_object, beowulf::chain::account_authority_index )

//FC_REFLECT( beowulf::chain::vesting_delegation_object,
//            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::vesting_delegation_object, beowulf::chain::vesting_delegation_index )

//FC_REFLECT( beowulf::chain::vesting_delegation_expiration_object,
//            (id)(delegator)(vesting_shares)(expiration) )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::vesting_delegation_expiration_object, beowulf::chain::vesting_delegation_expiration_index )

FC_REFLECT( beowulf::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::owner_authority_history_object, beowulf::chain::owner_authority_history_index )

//FC_REFLECT( beowulf::chain::account_recovery_request_object,
//             (id)(account_to_recover)(new_owner_authority)(expires)
//          )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::account_recovery_request_object, beowulf::chain::account_recovery_request_index )

//FC_REFLECT( beowulf::chain::change_recovery_account_request_object,
//             (id)(account_to_recover)(recovery_account)(effective_on)
//          )
//CHAINBASE_SET_INDEX_TYPE( beowulf::chain::change_recovery_account_request_object, beowulf::chain::change_recovery_account_request_index )
