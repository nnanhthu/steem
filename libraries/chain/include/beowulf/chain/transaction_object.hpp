...
FC_REFLECT( beowulf::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( beowulf::chain::transaction_object, beowulf::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<beowulf::chain::transaction_index>
   {
   public:
      typedef beowulf::chain::transaction_index IndexType;
      typedef typename beowulf::chain::transaction_object::t_packed_trx t_packed_trx;
