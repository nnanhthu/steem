...
namespace beowulf { namespace chain {
   ...
   using beowulf::protocol::weight_type;
...
FC_REFLECT_TYPENAME( beowulf::chain::shared_authority::account_authority_map)
FC_REFLECT( beowulf::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
