...
//   }
   ...
   class database : public chainbase::database
   {
      public:
         ...
         /**
          * Get fee from operation, this fee will be transferred to miner account
          * @param op
          * @param result
          */
...
//#endif
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = STEEM_INIT_SUPPLY, uint64_t initial_sbd_supply = SBD_INIT_SUPPLY );
