...
#include <beowulf/protocol/beowulf_virtual_operations.hpp>
...
//#endif
            //new operation, used to convert beowulf to sbd
...
/*namespace fc {
    void to_variant( const beowulf::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  beowulf::protocol::operation& vo );
}*/

BEOWULF_DECLARE_OPERATION_TYPE( beowulf::protocol::operation )
FC_REFLECT_TYPENAME( beowulf::protocol::operation )
