...
#include <beowulf/protocol/optional_automated_actions.hpp>
...
FC_REFLECT_TYPENAME( beowulf::protocol::block_header_extensions )

FC_REFLECT( beowulf::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( beowulf::protocol::signed_block_header, (beowulf::protocol::block_header), (witness_signature) )
