...
//         :author(a), permlink(p), sbd_payout(s), beowulf_payout(st), vesting_payout(v){}
//
//      account_name_type author;
//      string            permlink;
//      asset             sbd_payout;
//      asset             beowulf_payout;
...
//         : benefactor( b ), author( a ), permlink( p ), sbd_payout( s ), beowulf_payout( st ), vesting_payout( v ) {}
//
...
//FC_REFLECT( beowulf::protocol::author_reward_operation, (author)(permlink)(sbd_payout)(beowulf_payout)(vesting_payout) )
//FC_REFLECT( beowulf::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
//FC_REFLECT( beowulf::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( beowulf::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( beowulf::protocol::liquidity_reward_operation, (owner)(payout) )
//FC_REFLECT( beowulf::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( beowulf::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( beowulf::protocol::shutdown_witness_operation, (owner) )
//FC_REFLECT( beowulf::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
//FC_REFLECT( beowulf::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( beowulf::protocol::hardfork_operation, (hardfork_id) )
//FC_REFLECT( beowulf::protocol::comment_payout_update_operation, (author)(permlink) )
//FC_REFLECT( beowulf::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
//FC_REFLECT( beowulf::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(sbd_payout)(beowulf_payout)(vesting_payout) )
FC_REFLECT( beowulf::protocol::producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( beowulf::protocol::clear_null_account_balance_operation, (total_cleared) )
