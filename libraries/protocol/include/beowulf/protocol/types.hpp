...
#include <beowulf/protocol/fixed_string.hpp>
...
namespace beowulf {
   ...
   namespace protocol {
      ...
      #define BEOWULF_INIT_PUBLIC_KEY (beowulf::protocol::public_key_type(BEOWULF_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const beowulf::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  beowulf::protocol::public_key_type& vo );
    void to_variant( const beowulf::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, beowulf::protocol::extended_public_key_type& vo );
    void to_variant( const beowulf::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, beowulf::protocol::extended_private_key_type& vo );
}

FC_REFLECT( beowulf::protocol::public_key_type, (key_data) )
FC_REFLECT( beowulf::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( beowulf::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( beowulf::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( beowulf::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( beowulf::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( beowulf::protocol::share_type )

FC_REFLECT( beowulf::void_t, )
