...
{
   class variant;
   void to_variant( const beowulf::protocol::version& v, variant& var );
   void from_variant( const variant& var, beowulf::protocol::version& v );

   void to_variant( const beowulf::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, beowulf::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( beowulf::protocol::version, (v_num) )
FC_REFLECT_DERIVED( beowulf::protocol::hardfork_version, (beowulf::protocol::version), )

FC_REFLECT( beowulf::protocol::hardfork_version_vote, (hf_version)(hf_time) )
