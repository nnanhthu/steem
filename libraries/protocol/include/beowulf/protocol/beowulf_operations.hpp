...
//    *  @see SMT spec for details: https://github.com/beowulfit/smt-whitepaper/blob/master/smt-manual/manual.md
//    */
...
//         FC_ASSERT(is_allowed(BEOWULF_SYMBOL) == false,
//            "BEOWULF can not be explicitly specified as one of allowed_vote_assets");
//      }
//
...
//   typedef flat_set< comment_options_extension > comment_options_extensions_type;
    ...
    *  The percent_beowulf_dollars may be decreased, but never increased
    *
    */
...
//      uint16_t          percent_beowulf_dollars  = BEOWULF_100_PERCENT; /// the percent of Steem Dollars to key, unkept amounts will be received as Steem Power
...
//   };
    ...
    * @ingroup operations
    *
    * @brief Transfers BEOWULF from one account to another.
    */
...
//      asset             beowulf_amount = asset( 0, BEOWULF_SYMBOL );
//      asset             fee;
//
...
//      asset             beowulf_amount = asset( 0, BEOWULF_SYMBOL ); ///< the amount of beowulf to release
//
//      void validate()const;
//      void get_required_active_authorities( flat_set<account_name_type>& a )const{ a.insert(who); }
//   };
   ...
   /**
    *  This operation converts liquid token (BEOWULF or liquid SMT) into VFS (Vesting Fund Shares,
   ...
   struct transfer_to_vesting_operation : public base_operation
   {
      ...
      asset             amount;  ///< must be BEOWULF or liquid variant of SMT
    ...
    * vests to beowulf and back, guaranteeing they maintain their value.
    */
   ...
   struct legacy_chain_properties
   {
       ...
       */
      legacy_sbd_asset account_creation_fee = legacy_sbd_asset::from_amount( BEOWULF_MIN_ACCOUNT_CREATION_FEE );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = BEOWULF_MIN_BLOCK_SIZE_LIMIT * 2;
//      uint16_t          sbd_interest_rate  = BEOWULF_DEFAULT_SBD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= BEOWULF_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= BEOWULF_MIN_BLOCK_SIZE_LIMIT);
//         FC_ASSERT( sbd_interest_rate >= 0 );
//         FC_ASSERT( sbd_interest_rate <= BEOWULF_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, BEOWULF_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
...
//   };
    ...
    *  used to define the exchange rate between beowulf and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between BEOWULF and SBD,
    *  The funds are deposited after BEOWULF_CONVERSION_DELAY
    */
...
//   };
    ...
    * BEOWULF_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting beowulf.
    *
    * The result of the operation is to transfer the full VESTING BEOWULF balance
...
//   };
   ...
   /**
   *  This operation instructs the blockchain to start a conversion from BEOWULF to SBD,
...
//FC_REFLECT( beowulf::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
//FC_REFLECT( beowulf::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
//FC_REFLECT( beowulf::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )
//
//FC_REFLECT( beowulf::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
//FC_REFLECT( beowulf::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( beowulf::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( beowulf::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( beowulf::protocol::feed_publish_operation, (publisher)(exchange_rate) )
//FC_REFLECT( beowulf::protocol::pow, (worker)(input)(signature)(work) )
//FC_REFLECT( beowulf::protocol::pow2, (input)(pow_summary) )
//FC_REFLECT( beowulf::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
//FC_REFLECT( beowulf::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( beowulf::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            //(sbd_interest_rate)
          )

//FC_REFLECT_TYPENAME( beowulf::protocol::pow2_work )
//FC_REFLECT( beowulf::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
//FC_REFLECT( beowulf::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( beowulf::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
//FC_REFLECT( beowulf::protocol::account_create_with_delegation_operation,
//            (fee)
//            (delegation)
//            (creator)
//            (new_account_name)
...
//            (extensions) )
//
FC_REFLECT( beowulf::protocol::account_update_operation,
            (account)
            (owner)
            (active)
//            (posting)
...
FC_REFLECT( beowulf::protocol::transfer_operation, (from)(to)(amount)(fee)(memo) )
FC_REFLECT( beowulf::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( beowulf::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( beowulf::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( beowulf::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( beowulf::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( beowulf::protocol::account_witness_vote_operation, (account)(witness)(approve) )
//FC_REFLECT( beowulf::protocol::account_witness_proxy_operation, (account)(proxy) )
//FC_REFLECT( beowulf::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
//FC_REFLECT( beowulf::protocol::vote_operation, (voter)(author)(permlink)(weight) )
//FC_REFLECT( beowulf::protocol::custom_operation, (required_auths)(id)(data) )
//FC_REFLECT( beowulf::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
//FC_REFLECT( beowulf::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
//FC_REFLECT( beowulf::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
//FC_REFLECT( beowulf::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
//FC_REFLECT( beowulf::protocol::limit_order_cancel_operation, (owner)(orderid) )

//FC_REFLECT( beowulf::protocol::delete_comment_operation, (author)(permlink) );

//FC_REFLECT( beowulf::protocol::beneficiary_route_type, (account)(weight) )
//FC_REFLECT( beowulf::protocol::comment_payout_beneficiaries, (beneficiaries) )

//#ifdef BEOWULF_ENABLE_SMT
//FC_REFLECT( beowulf::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
//FC_REFLECT( beowulf::protocol::allowed_vote_assets, (votable_assets) )
//#endif

//FC_REFLECT_TYPENAME( beowulf::protocol::comment_options_extension )
//FC_REFLECT( beowulf::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_beowulf_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

//FC_REFLECT( beowulf::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(beowulf_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
//FC_REFLECT( beowulf::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
//FC_REFLECT( beowulf::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
//FC_REFLECT( beowulf::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(beowulf_amount) );
//FC_REFLECT( beowulf::protocol::claim_account_operation, (creator)(fee)(extensions) );
//FC_REFLECT( beowulf::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
//FC_REFLECT( beowulf::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
//FC_REFLECT( beowulf::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
//FC_REFLECT( beowulf::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
//FC_REFLECT( beowulf::protocol::decline_voting_rights_operation, (account)(decline) );
//FC_REFLECT( beowulf::protocol::claim_reward_balance_operation, (account)(reward_beowulf)(reward_sbd)(reward_vests) )
//#ifdef BEOWULF_ENABLE_SMT
//FC_REFLECT( beowulf::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
//#endif
//FC_REFLECT( beowulf::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( beowulf::protocol::convert_to_sbd_operation, (owner)(amount) )