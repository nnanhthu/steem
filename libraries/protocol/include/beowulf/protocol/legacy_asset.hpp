...
template< typename Stream >
inline void unpack( Stream& s, beowulf::protocol::legacy_sbd_asset_symbol_type& sym, uint32_t depth )
{
   //  994240:        "account_creation_fee": "0.1 BEOWULF"
   // 1021529:        "account_creation_fee": "10.0 BEOWULF"
   // 3143833:        "account_creation_fee": "3.000 BEOWULF"
   // 3208405:        "account_creation_fee": "2.000 BEOWULF"
   // 3695672:        "account_creation_fee": "3.00 BEOWULF"
...
{
   beowulf::protocol::asset a;
   from_variant( v, a );
   leg = beowulf::protocol::legacy_sbd_asset::from_asset( a );
}

template<>
struct get_typename< beowulf::protocol::legacy_sbd_asset_symbol_type >
{
   static const char* name()
   {
      return "beowulf::protocol::legacy_sbd_asset_symbol_type";
   }
};

} // fc

FC_REFLECT( beowulf::protocol::legacy_sbd_asset,
   (amount)
   (symbol)
   )
