 ...
 * - Length is between (inclusive) BEOWULF_MIN_ACCOUNT_NAME_LENGTH and BEOWULF_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace beowulf::protocol


FC_REFLECT_TYPENAME( beowulf::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( beowulf::protocol::authority::key_authority_map)
FC_REFLECT( beowulf::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( beowulf::protocol::authority::classification, (owner)(active)(key) )
