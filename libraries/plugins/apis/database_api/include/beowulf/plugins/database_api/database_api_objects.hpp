...
//      percent_beowulf_dollars( o.percent_beowulf_dollars ),
...
//      savings_withdraw_requests( a.savings_withdraw_requests ),
      ...
      reward_beowulf_balance( a.reward_beowulf_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_beowulf( a.reward_vesting_beowulf ),
...
//   uint8_t           savings_withdraw_requests = 0;
   ...
   asset             reward_beowulf_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_beowulf;
...
{
   price                order_price;
   double               real_price; // dollars per beowulf
   share_type           beowulf;
   share_type           sbd;
...
//FC_REFLECT( beowulf::plugins::database_api::api_comment_object,
//             (id)(author)(permlink)
...
//          )
//
//FC_REFLECT( beowulf::plugins::database_api::api_comment_vote_object,
//             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
//          )

FC_REFLECT( beowulf::plugins::database_api::api_account_object,
...
FC_REFLECT( beowulf::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
//FC_REFLECT( beowulf::plugins::database_api::api_account_recovery_request_object,
//             (id)
//             (account_to_recover)
//             (new_owner_authority)
//             (expires)
//          )
//
//FC_REFLECT( beowulf::plugins::database_api::api_savings_withdraw_object,
//             (id)
//             (from)
//             (to)
//             (memo)
...
FC_REFLECT( beowulf::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( beowulf::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( beowulf::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( beowulf::plugins::database_api::api_signed_block_object, (beowulf::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( beowulf::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( beowulf::plugins::database_api::order, (order_price)(real_price)(beowulf)(sbd)(created) );

FC_REFLECT( beowulf::plugins::database_api::order_book, (asks)(bids) );
