...
#include <beowulf/plugins/block_api/block_api.hpp>
#include <beowulf/plugins/account_history_api/account_history_api.hpp>
#include <beowulf/plugins/account_by_key_api/account_by_key_api.hpp>
#include <beowulf/plugins/network_broadcast_api/network_broadcast_api.hpp>

#include <beowulf/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
//      savings_withdraw_requests( a.savings_withdraw_requests ),
      ...
      reward_beowulf_balance( legacy_asset::from_asset( a.reward_beowulf_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_beowulf( legacy_asset::from_asset( a.reward_vesting_beowulf ) ),
...
//   uint8_t           savings_withdraw_requests = 0;
   ...
   legacy_asset      reward_beowulf_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_beowulf;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting beowulf
...
//      percent_beowulf_dollars( c.percent_beowulf_dollars ),
...
//   uint16_t          percent_beowulf_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      total_vesting_fund_beowulf( legacy_asset::from_asset( o.total_vesting_fund_beowulf ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_beowulf( legacy_asset::from_asset( o.total_reward_fund_beowulf ) ),
      ...
      pending_rewarded_vesting_beowulf( legacy_asset::from_asset( o.pending_rewarded_vesting_beowulf ) ),
...
//      delegation_return_period( o.delegation_return_period ),
   ...
   legacy_asset      total_vesting_fund_beowulf;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_beowulf;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_beowulf;

   uint16_t          sbd_interest_rate = 0;
   uint16_t          sbd_print_rate = BEOWULF_100_PERCENT;
   ...
   uint32_t          vote_power_reserve_rate = BEOWULF_INITIAL_VOTE_POWER_RATE;
//   uint32_t          delegation_return_period = BEOWULF_DELEGATION_RETURN_PERIOD_HF0;
...
//      available_witness_account_subsidies( w.available_witness_account_subsidies )
   ...
   time_point_sec          hardfork_time_vote = BEOWULF_GENESIS_TIME;
...
//      min_witness_account_subsidy_decay( w.min_witness_account_subsidy_decay )
   ...
   uint8_t                       max_voted_witnesses           = BEOWULF_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = BEOWULF_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = BEOWULF_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = BEOWULF_HARDFORK_REQUIRED_WITNESSES;
...
//      beowulf_balance( legacy_asset::from_asset( e.beowulf_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), beowulf_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string beowulf_revision;
...
//      beowulf_volume( legacy_asset::from_asset( t.beowulf_volume ) ),
...
//      beowulf_volume( legacy_asset::from_asset( v.beowulf_volume ) ),
...
//FC_REFLECT( beowulf::plugins::condenser_api::discussion_index,
...
//FC_REFLECT( beowulf::plugins::condenser_api::api_tag_object,
//            (name)(total_payouts)(net_votes)(top_posts)(comments)(trending) )

FC_REFLECT( beowulf::plugins::condenser_api::state,
            (current_route)(props)(accounts)(witnesses)(witness_schedule)(feed_price)(error) )

//FC_REFLECT( beowulf::plugins::condenser_api::api_limit_order_object,
//            (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price)(real_price)(rewarded) )

FC_REFLECT( beowulf::plugins::condenser_api::api_operation_object,
             (trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(op) )

FC_REFLECT( beowulf::plugins::condenser_api::api_account_object,
             (id)(name)(owner)(active)(json_metadata)(last_owner_update)
             (created)(mined)
//             (recovery_account)(last_account_recovery)(reset_account)
//             (comment_count)(lifetime_vote_count)(post_count)(can_vote)
             (voting_manabar)(voting_power)
             (balance)
//             (savings_balance)
             (sbd_balance)(sbd_seconds)(sbd_seconds_last_update)
//             (sbd_last_interest_payment)
//             (savings_sbd_balance)(savings_sbd_seconds)(savings_sbd_seconds_last_update)(savings_sbd_last_interest_payment)(savings_withdraw_requests)
             (reward_sbd_balance)(reward_beowulf_balance)(reward_vesting_balance)(reward_vesting_beowulf)
             (vesting_shares)
...
FC_REFLECT_DERIVED( beowulf::plugins::condenser_api::extended_account, (beowulf::plugins::condenser_api::api_account_object),
            (vesting_balance)(transfer_history)(other_history)(witness_votes)
//            (guest_bloggers)(open_orders)(comments)(feed)(blog)(recent_replies)(recommended)
)

//FC_REFLECT( beowulf::plugins::condenser_api::api_comment_object,
//             (id)(author)(permlink)
...
//             (max_accepted_payout)(percent_beowulf_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
//             (beneficiaries)
//          )

FC_REFLECT( beowulf::plugins::condenser_api::extended_dynamic_global_properties,
            ...
            (total_vesting_fund_beowulf)(total_vesting_shares)
            (total_reward_fund_beowulf)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_beowulf)
            ...
            (reverse_auction_seconds)(sbd_stop_percent)(sbd_start_percent) )

FC_REFLECT( beowulf::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( beowulf::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( beowulf::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

//FC_REFLECT( beowulf::plugins::condenser_api::api_reward_fund_object,
//            (id)
//            (name)
//            (reward_balance)
//            (recent_claims)
...
//FC_REFLECT( beowulf::plugins::condenser_api::api_escrow_object,
//             (id)(escrow_id)(from)(to)(agent)
//             (ratification_deadline)(escrow_expiration)
//             (sbd_balance)(beowulf_balance)(pending_fee)
//             (to_approved)(agent_approved)(disputed) )

//FC_REFLECT( beowulf::plugins::condenser_api::api_savings_withdraw_object,
//             (id)
//             (from)
//             (to)
//             (memo)
...
//FC_REFLECT( beowulf::plugins::condenser_api::api_vesting_delegation_object,
//            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::api_vesting_delegation_expiration_object,
//            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( beowulf::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

//FC_REFLECT_DERIVED( beowulf::plugins::condenser_api::discussion, (beowulf::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( beowulf::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

//FC_REFLECT( beowulf::plugins::condenser_api::account_vote,
//            (authorperm)(weight)(rshares)(percent)(time) )

//FC_REFLECT( beowulf::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( beowulf::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( beowulf::plugins::condenser_api::get_version_return,
            (blockchain_version)(beowulf_revision)(fc_revision) )

FC_REFLECT( beowulf::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

//FC_REFLECT( beowulf::plugins::condenser_api::comment_feed_entry,
//            (comment)(reblog_by)(reblog_on)(entry_id) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::comment_blog_entry,
//            (comment)(blog)(reblog_on)(entry_id) )

//FC_REFLECT( beowulf::plugins::condenser_api::ticker,
//            (latest)(lowest_ask)(highest_bid)(percent_change)(beowulf_volume)(sbd_volume) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::volume,
//            (beowulf_volume)(sbd_volume) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::order,
//            (order_price)(real_price)(beowulf)(sbd)(created) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::order_book,
//            (bids)(asks) )
//
//FC_REFLECT( beowulf::plugins::condenser_api::market_trade,
