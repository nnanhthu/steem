...
#include <beowulf/plugins/condenser_api/condenser_api_legacy_asset.hpp>
...
//                int32_t        account_subsidy_budget = BEOWULF_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
//                uint32_t       account_subsidy_decay = BEOWULF_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
            };
...
//         percent_beowulf_dollars( op.percent_beowulf_dollars ),
...
//         op.percent_beowulf_dollars = percent_beowulf_dollars;
...
//      uint16_t          percent_beowulf_dollars;
//      bool              allow_votes;
...
//         beowulf_amount( legacy_asset::from_asset( op.beowulf_amount ) ),
//         fee( legacy_asset::from_asset( op.fee ) ),
...
//         op.beowulf_amount = beowulf_amount;
//         op.fee = fee;
...
//                        account( op.account ),
//                        reward_beowulf( legacy_asset::from_asset( op.reward_beowulf ) ),
...
//                   op.account = account;
//                   op.reward_beowulf = reward_beowulf;
...
//         beowulf_payout( legacy_asset::from_asset( op.beowulf_payout ) ),
...
//         op.beowulf_payout = beowulf_payout;
...
//                }
                ...
                {
                   l_op = legacy_smt_create_operation( op );
                   return true;
                }
...
namespace fc {
    ...
    void to_variant( const beowulf::plugins::condenser_api::legacy_operation&, fc::variant& );
    void from_variant( const fc::variant&, beowulf::plugins::condenser_api::legacy_operation& );

//    void to_variant( const beowulf::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
//    void from_variant( const fc::variant&, beowulf::plugins::condenser_api::legacy_comment_options_extensions& );
//
//    void to_variant( const beowulf::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
//    void from_variant( const fc::variant&, beowulf::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( beowulf::plugins::condenser_api::api_chain_properties,
(account_creation_fee)(maximum_block_size)
//(sbd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
)

FC_REFLECT( beowulf::plugins::condenser_api::legacy_price, (base)(quote) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( beowulf::plugins::condenser_api::legacy_account_create_operation,
(fee)
        (creator)
        (new_account_name)
(owner)
...
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_account_create_with_delegation_operation,
//(fee)
//        (delegation)
//        (creator)
//        (new_account_name)
...
FC_REFLECT( beowulf::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(fee)(memo) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_beowulf_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(sbd_amount)(beowulf_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(beowulf_amount) );
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_beowulf)(reward_sbd)(reward_vests) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(sbd_payout)(beowulf_payout)(vesting_payout) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_return_vesting_delegation_operation, (account)(vesting_shares) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(sbd_payout)(beowulf_payout)(vesting_payout) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_producer_reward_operation, (producer)(vesting_shares) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_smt_create_operation,
(smt_creation_fee)
        (precision)
        (extensions)
        (control_account)
(symbol) )
FC_REFLECT( beowulf::plugins::condenser_api::legacy_smt_setup_operation,
(decimal_places)
        (max_supply)
...
//        (launch_expiration_time)
        ...
        (control_account)
(symbol) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_smt_setup_emissions_operation,
//(schedule_time)
//        (emissions_unit)
//        (interval_seconds)
//        (interval_count)
...
//        (control_account)
//(symbol) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_smt_set_setup_parameters_operation,
//(setup_parameters)
//        (extensions)
//        (control_account)
//(symbol) )
//FC_REFLECT( beowulf::plugins::condenser_api::legacy_smt_set_runtime_parameters_operation,
//(runtime_parameters)
//        (extensions)
//        (control_account)
//(symbol) )

FC_REFLECT( beowulf::plugins::condenser_api::legacy_convert_to_sbd_operation, (owner)(amount) )

FC_REFLECT_TYPENAME( beowulf::plugins::condenser_api::legacy_operation )
