...
void to_variant( const beowulf::plugins::condenser_api::legacy_block_header_extensions&, fc::variant& );
void from_variant( const fc::variant&, beowulf::plugins::condenser_api::legacy_block_header_extensions& );

}

FC_REFLECT( beowulf::plugins::condenser_api::legacy_signed_transaction,
            (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions)(signatures)(transaction_id)(block_num)(transaction_num) )

FC_REFLECT( beowulf::plugins::condenser_api::legacy_signed_block,
