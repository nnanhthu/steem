...
#include <beowulf/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > BEOWULF_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( BEOWULF_DEBUG_NODE_API_PLUGIN_NAME );
}
