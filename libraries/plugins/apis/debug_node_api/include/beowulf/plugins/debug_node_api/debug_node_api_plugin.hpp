...
#define BEOWULF_DEBUG_NODE_API_PLUGIN_NAME "debug_node_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (beowulf::plugins::debug_node::debug_node_plugin)
   ...
   static const std::string& name() { static std::string name = BEOWULF_DEBUG_NODE_API_PLUGIN_NAME; return name; }
