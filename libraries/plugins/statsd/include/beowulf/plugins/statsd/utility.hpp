...
namespace beowulf { namespace plugins { namespace statsd { namespace util {

using beowulf::plugins::statsd::statsd_plugin;
...
} } } } // beowulf::plugins::statsd::util

#define STATSD_INCREMENT( NAMESPACE, STAT, KEY, FREQ )   \
if( beowulf::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   beowulf::plugins::statsd::util::get_statsd().increment( \
...
if( beowulf::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   beowulf::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( beowulf::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   beowulf::plugins::statsd::util::get_statsd().count(     \
...
if( beowulf::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   beowulf::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< beowulf::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( beowulf::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = beowulf::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, beowulf::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( beowulf::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   beowulf::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      beowulf::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
