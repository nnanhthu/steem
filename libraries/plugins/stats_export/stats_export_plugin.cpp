...
#include <beowulf/plugins/block_data_export/exportable_block_data.hpp>
...
namespace beowulf { namespace plugins { namespace stats_export {

using beowulf::chain::block_notification;
using beowulf::chain::database;
using beowulf::chain::dynamic_global_property_object;
...
using beowulf::plugins::block_data_export::exportable_block_data;

using beowulf::plugins::chain::chain_plugin;
...
FC_REFLECT( beowulf::plugins::stats_export::detail::api_stats_transaction_data_object, (user)(size) )
FC_REFLECT( beowulf::plugins::stats_export::detail::api_stats_export_data_object, (global_properties)(transaction_stats)(free_memory) )

namespace beowulf { namespace plugins { namespace stats_export { namespace detail {
...
//   flat_set< account_name_type > posting;
   ...
   tx.get_required_authorities( active, owner, other );
...
{
   std::shared_ptr< api_stats_export_data_object > stats = _export_plugin.find_export_data< api_stats_export_data_object >( BEOWULF_STATS_EXPORT_PLUGIN_NAME );
   if( !stats )
      return;
...
void stats_export_plugin::plugin_initialize( const boost::program_options::variables_map& options )
{
   ...
   try
   {
      ...
      my->_export_plugin.register_export_data_factory( BEOWULF_STATS_EXPORT_PLUGIN_NAME,
