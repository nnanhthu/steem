...
namespace beowulf { namespace plugins { namespace block_data_export {
...
FC_REFLECT( beowulf::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace beowulf { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // beowulf::plugins::block_data_export
