...
#ifndef BEOWULF_SMT_TEST_SPACE_ID
#define BEOWULF_SMT_TEST_SPACE_ID 13
#endif

enum smt_test_object_types
{
   smt_token_object_type = ( BEOWULF_SMT_TEST_SPACE_ID << 8 )
};
...
class smt_token_object : public object< smt_token_object_type, smt_token_object >
{
   public:
      ...
      int64_t                 max_supply = BEOWULF_MAX_SHARE_SUPPLY;
...
FC_REFLECT( beowulf::plugins::smt_test::smt_token_object,
   (id)
   (control_account)
   (decimal_places)
   (max_supply)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::plugins::smt_test::smt_token_object, beowulf::plugins::smt_test::smt_token_index )
