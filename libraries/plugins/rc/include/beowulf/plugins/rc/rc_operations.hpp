...
BEOWULF_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_to_pool_operation );
BEOWULF_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_drc_from_pool_operation );

} } } // beowulf::plugins::rc

FC_REFLECT( beowulf::plugins::rc::delegate_to_pool_operation,
   (from_account)
   (to_pool)
   (amount)
   )
FC_REFLECT( beowulf::plugins::rc::delegate_drc_from_pool_operation,
   (from_pool)
   (to_account)
   (mana_change)
   (drc_max_mana)
...
BEOWULF_DECLARE_OPERATION_TYPE( beowulf::plugins::rc::rc_plugin_operation )
FC_REFLECT_TYPENAME( beowulf::plugins::rc::rc_plugin_operation )
