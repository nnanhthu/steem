...
#include <beowulf/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const beowulf::app::api_context& ctx );
...
FC_REFLECT( beowulf::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( beowulf::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
