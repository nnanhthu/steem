...
// time.
//
#ifndef BEOWULF_BLOCKCHAIN_STATISTICS_SPACE_ID
#define BEOWULF_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef BEOWULF_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define BEOWULF_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif

namespace beowulf { namespace blockchain_statistics {
...
{
   bucket_object_type = ( BEOWULF_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public beowulf::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return BEOWULF_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           beowulf_transferred = 0;                       ///< BEOWULF transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of BEOWULF paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of BEOWULF into VESTS
   share_type           beowulf_vested = 0;                            ///< Ammount of BEOWULF vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to BEOWULF
...
} } // beowulf::blockchain_statistics

FC_REFLECT( beowulf::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( beowulf::blockchain_statistics::bucket_object, beowulf::blockchain_statistics::bucket_index )
