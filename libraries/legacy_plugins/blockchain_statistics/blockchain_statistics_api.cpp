...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( beowulf::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( BEOWULF_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const beowulf::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->beowulf_transferred                      += b.beowulf_transferred;
   ...
   this->beowulf_vested                           += b.beowulf_vested;
   ...
   this->beowulf_converted                        += b.beowulf_converted;
