...
struct private_message_operation : public beowulf::protocol::base_operation
{
...
FC_REFLECT( beowulf::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

BEOWULF_DECLARE_OPERATION_TYPE( beowulf::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( beowulf::private_message::private_message_plugin_operation )
