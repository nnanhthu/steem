...
// time.
//
#ifndef BEOWULF_ACCOUNT_STATISTICS_SPACE_ID
#define BEOWULF_ACCOUNT_STATISTICS_SPACE_ID 10
#endif

#ifndef BEOWULF_ACCOUNT_STATISTICS_PLUGIN_NAME
#define BEOWULF_ACCOUNT_STATISTICS_PLUGIN_NAME "account_stats"
#endif
...
{
   account_stats_bucket_object_type    = ( BEOWULF_ACCOUNT_STATISTICS_SPACE_ID << 8 ),
   account_activity_bucket_object_type = ( BEOWULF_ACCOUNT_STATISTICS_SPACE_ID << 8 ) + 1
};
...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_beowulf_value = 0;     ///< BEOWULF Value of author rewards
   ...
   share_type           curation_rewards_beowulf_value = 0;         ///< BEOWULF Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of BEOWULF paid as liquidity rewards
   ...
   share_type           beowulf_sent = 0;                           ///< BEOWULF sent from this account
   share_type           beowulf_received = 0;                       ///< BEOWULF received by this account
   ...
   share_type           beowulf_vested = 0;                         ///< BEOWULF vested by the account
   ...
   share_type           beowulf_received_from_withdrawls = 0;       ///< BEOWULF received from this account's vesting withdrawals
   share_type           beowulf_received_from_routes = 0;           ///< BEOWULF received from another account's vesting withdrawals
   ...
   share_type           beowulf_converted = 0;                      ///< Amount of BEOWULF that was converted
   ...
   share_type           limit_order_beowulf_paid = 0;               ///< BEOWULF paid by limit orders
   share_type           limit_order_beowulf_received = 0;           ///< BEOWULF received from limit orders
...
class account_statistics_plugin : public beowulf::app::plugin
{
   public:
      account_statistics_plugin( application* app );
      virtual ~account_statistics_plugin();

      virtual std::string plugin_name()const override { return BEOWULF_ACCOUNT_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( beowulf::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (beowulf_received_from_withdrawls)
   (beowulf_received_from_routes)
   ...
   (limit_order_beowulf_paid)
   (limit_order_beowulf_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( beowulf::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   beowulf::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
