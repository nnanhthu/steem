...
int main( int argc, char** argv, char** envp )
{
   try
   {
      //beowulf::chain::database db;
      beowulf::chain::block_log log;
      ...
      beowulf::protocol::signed_block b1;
      b1.witness = "alice";
      b1.previous = beowulf::protocol::block_id_type();
      ...
      beowulf::protocol::signed_block b2;
      b2.witness = "bob";
      b2.previous = b1.id();
